...
public class ChromaToTransparency {
    ...
    public ChromaToTransparency(){
        MarvinImage image = MarvinImageIO.loadImage("./res/small.JPG");
        MarvinImage imageOut = new MarvinImage(image.getWidth(), image.getHeight());
        MarvinImage original = image.clone();
        ...
        MarvinImage bin = MarvinColorModelConverter.rgbToBinary(image, 200);
